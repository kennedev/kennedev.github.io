...
site_head('Contato', array('canonical' => SITE_URL . '/contato.php',
    'desc' => 'Fale com a Vicente Corretor de Imóveis. WhatsApp, telefone e formulário de contato.'));
?>
...
<section class="section" style="padding-top:30px">
  <div class="shell contato-grid">
    <div class="contato-info reveal">
      ...
      <div class="linha">
        <?php echo icone('phone'); ?><span><b>Telefones</b><span><a href="<?php echo e(tel_href(SITE_TEL_U1)); ?>"><?php echo e(SITE_TEL_U1); ?></a> · <a href="<?php echo e(tel_href(SITE_TEL_U1_2)); ?>"><?php echo e(SITE_TEL_U1_2); ?></a></span></span>
      </div>
      <a class="linha" href="mailto:<?php echo e(SITE_EMAIL); ?>">
        <?php echo icone('mail'); ?><span><b>E-mail</b><span><?php echo e(SITE_EMAIL); ?></span></span>
      </a>
      <div class="linha">
        <?php echo icone('pino'); ?><span><b>Endereço</b><span><?php echo e(SITE_ENDERECO); ?> · <?php echo e(SITE_CRECI); ?></span></span>
      </div>
      <div class="linha" style="border-bottom:0">
        <?php echo icone('clock'); ?><span><b>Horário</b><span>Seg. a sex. 9h–18h · sáb. 9h–14h</span></span>
      </div>
    </div>
