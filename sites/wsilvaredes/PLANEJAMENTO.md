# PLANEJAMENTO — Site institucional WSILVA Redes
...
- **Identidade:** o visual final deve ser **institucional e próprio da WSILVA** (sobrescritas em `style.css`); evitar aparência genérica de template Bootstrap.
...
- **Canonical / OG:** somente URLs absolutas `https://wsilvaredes.com.br/...` (sem caminhos locais tipo `c:\`).

## 1. Objetivo do site

Apresentar a **WSILVA Redes** como fornecedora de redes e telas de proteção para janelas, sacadas, apartamentos, famílias e pets; transmitir profissionalismo, segurança e clareza; e **converter visitantes em orçamentos via WhatsApp** (5511991237392), com formulário que monta a mensagem automaticamente.
...
- **CTA WhatsApp flutuante:** link fixo `https://wa.me/5511991237392`, posição segura no mobile.
...
- **Canonical e URLs:** sempre absolutas com `https://wsilvaredes.com.br/` + caminho (ex.: `/`, `/servicos.html`, `/quem-somos.html`, `/faq.html`, `/contato.html`). Nunca URL de disco local.
...
|--------|----------------|
| Home | WSILVA Redes \| Redes de Proteção para Janelas e Sacadas |
| Serviços | Serviços \| WSILVA Redes |
| Quem somos | Quem Somos \| WSILVA Redes |
| FAQ | Perguntas Frequentes \| WSILVA Redes |
| Contato | Contato \| WSILVA Redes |
...
- **Canonical `https://wsilvaredes.com.br/`:** produção; referência correta para SEO e compartilhamento.
