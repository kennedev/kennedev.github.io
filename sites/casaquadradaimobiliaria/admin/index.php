...
if (admin_id()) {
    ...
    echo '<div class="card" style="margin:0"><label>Leads não lidos</label><div style="font-size:34px;font-weight:800;color:#A87E4F">' . $totLeads . '</div></div>';
    echo '</div>';
...
if (!$temAdmin) {
    echo '<h1>Primeiro acesso</h1><p class="sub">Crie o administrador principal da Imobiliaria.</p>';
