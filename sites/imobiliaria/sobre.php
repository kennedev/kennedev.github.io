...
site_head('Sobre', array('canonical' => SITE_URL . '/sobre.php',
    'desc' => 'Conheça a Luis Imóveis: atendimento próximo e transparente na compra, venda, locação e administração de imóveis.'));
?>
...
<section class="section" style="padding-top:30px">
  <div class="shell split">
    <div class="reveal">
      <img loading="lazy" src="https://images.unsplash.com/photo-1556912172-45b7abe8b7e1?auto=format&fit=crop&w=900&q=70" alt="Equipe Luis Imóveis">
    </div>
    <div class="reveal">
      <p class="lead" style="margin-bottom:18px">A Luis Imóveis é uma imobiliária de relacionamento: conhecemos a região, ouvimos quem compra e quem vende, e tratamos cada negócio com a atenção que ele merece.</p>
