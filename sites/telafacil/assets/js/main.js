/**
 * TelaFacil Redes de Proteção — site estático. jQuery e Bootstrap vêm do CDN no HTML.
 */
(function () {
  "use strict";
  ...
  $("#form-orcamento").on("submit", function (e) {
    ...
    var lines = [];
    lines.push("Olá, TelaFacil Redes de Proteção! Gostaria de solicitar um orçamento.");
    lines.push("");
    ...
    var url = "https://wa.me/5511990077134?text=" + encodeURIComponent(lines.join("\n"));
