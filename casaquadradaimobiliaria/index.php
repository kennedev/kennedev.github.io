...
<section class="hero">
  <div class="shell hero-inner reveal">
    <span class="eyebrow">Imobiliaria · Negócios Imobiliários</span>
    ...
    <form class="busca" method="get" action="imoveis.php" role="search" aria-label="Buscar imóveis">
      ...
      <div class="busca-campos">
        ...
        <input type="text" name="q" placeholder="Bairro, cidade ou código (ex.: CQ025)">
...
<section class="section">
  <div class="shell split">
    <div class="reveal">
      <img loading="lazy" src="https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?auto=format&fit=crop&w=900&q=70" alt="Atendimento Imobiliaria">
    </div>
    <div class="reveal">
      ...
      <p class="lead" style="margin-bottom:22px">A Imobiliaria nasceu para descomplicar a compra, a venda e a locação de imóveis — unindo conhecimento da região a um atendimento que trata cada negócio como único.</p>
      ...
      <a class="btn btn-dark" href="sobre.php">Conheça a Imobiliaria</a>
    </div>
  </div>
</section>
  ...
  <div class="shell">
    <div class="cta-band reveal">
      <div>
        ...
        <h2>Anuncie seu imóvel com a Imobiliaria.</h2>
