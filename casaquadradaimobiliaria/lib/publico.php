<?php
// Helpers compartilhados do site público da Imobiliaria.
...
if (!defined('SITE_NOME')) {
    define('SITE_NOME', 'Imobiliaria');
    define('SITE_TAGLINE', 'Negócios Imobiliários');
    define('SITE_CRECI', 'CRECI-J 43636');            // (confirmar formato)
    define('SITE_TEL_FIXO', '(11) 3384-6101');
    define('SITE_TEL_FIXO_RAW', '551133846101');
    define('SITE_WHATSAPP', '5511992605360');          // (confirmar)
    define('SITE_WHATSAPP_FMT', '(11) 99260-5360');
    define('SITE_EMAIL', 'contato@casaquadradaimobiliaria.com.br'); // (confirmar)
    define('SITE_URL', 'https://www.casaquadradaimobiliaria.com.br');
...
function garantir_db() {
    try {
        ...
        echo '<p style="color:#7A736A;margin-top:8px">Estamos preparando tudo. Volte em instantes.</p></div>';
        exit;
    }
}
...
function site_head($titulo, $opts = array()) {
    $desc = $opts['desc'] ?? 'Imóveis para compra e locação com a Imobiliaria Negócios Imobiliários. Casas, apartamentos, terrenos e imóveis comerciais.';
    ...
    echo '<a class="logo" href="index.php"><span class="logo-mark">CQ</span><span class="logo-txt">' . e(SITE_NOME) . '<small>' . e(SITE_TAGLINE) . '</small></span></a>';
...
function site_foot() {
    ...
    echo '<div class="f-brand"><a class="logo logo--light" href="index.php"><span class="logo-mark">CQ</span><span class="logo-txt">' . e(SITE_NOME) . '<small>' . e(SITE_TAGLINE) . '</small></span></a>';
    ...
    echo '<a href="tel:+' . e(SITE_TEL_FIXO_RAW) . '">' . e(SITE_TEL_FIXO) . '</a>';
