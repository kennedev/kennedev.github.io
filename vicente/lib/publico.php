<?php
// Helpers compartilhados do site público da Vicente Corretor de Imóveis.
...
// Extraídos do site/material do cliente. Itens (confirmar) precisam ser validados.
if (!defined('SITE_NOME')) {
    define('SITE_NOME', 'Vicente Corretor de Imóveis');
    define('SITE_TAGLINE', 'Seu imóvel em boas mãos');
    define('SITE_CRECI', 'CRECI 35030');
    // Telefones (escritório único — Anchieta/RJ)
    define('SITE_TEL_U1', '(21) 3358-2721');
    define('SITE_TEL_U1_2', '(21) 2455-0785');
    // Telefone principal (compat. com usos existentes)
    define('SITE_TEL_FIXO', '(21) 3358-2721');
    define('SITE_TEL_FIXO_RAW', '552133582721');
    // WhatsApp — (CONFIRMAR: nº de celular/WhatsApp do cliente; o fixo abaixo é placeholder)
    define('SITE_WHATSAPP', '552133582721');           // (placeholder — confirmar)
    define('SITE_WHATSAPP_FMT', '(21) 3358-2721');     // (placeholder — confirmar)
    define('SITE_EMAIL', 'atendimento@vicenteimoveis.com.br');
    define('SITE_URL', 'https://www.vicenteimoveis.com.br'); // (confirmar)
    define('SITE_CIDADE', 'Rio de Janeiro · RJ');
    define('SITE_ENDERECO', 'Estr. do Engenho Novo, 48 — Sala 205 · Anchieta, Rio de Janeiro/RJ');
...
function site_head($titulo, $opts = array()) {
    $desc = $opts['desc'] ?? 'Imóveis para compra, venda e locação com a Vicente Corretor de Imóveis. Casas, apartamentos, terrenos e imóveis comerciais em Anchieta e região, Rio de Janeiro.';
    ...
    echo '<a class="logo" href="index.php"><img class="logo-mark-img" src="assets/img/favicon.svg" alt="' . e(SITE_NOME) . '" height="40"><span class="logo-txt">' . e(SITE_NOME) . '<small>' . e(SITE_TAGLINE) . '</small></span></a>';
...
function site_foot() {
    ...
    echo '<div class="f-brand"><a class="logo logo--light" href="index.php"><img class="logo-mark-img" src="assets/img/favicon.svg" alt="' . e(SITE_NOME) . '" height="40"><span class="logo-txt">' . e(SITE_NOME) . '<small>' . e(SITE_TAGLINE) . '</small></span></a>';
    ...
    echo '<a href="' . e(tel_href(SITE_TEL_U1)) . '">' . e(SITE_TEL_U1) . '</a>';
    echo '<a href="' . e(tel_href(SITE_TEL_U1_2)) . '">' . e(SITE_TEL_U1_2) . '</a>';
    ...
    echo '<span class="muted">' . e(SITE_ENDERECO) . '</span></div>';
