...
<section class="hero">
  <div class="shell hero-inner reveal">
    <span class="eyebrow">Luis Imóveis · Compra · Vende · Aluga · Administra</span>
    ...
    <form class="busca" method="get" action="imoveis.php" role="search" aria-label="Buscar imóveis">
      ...
      <div class="busca-campos">
        ...
        <input type="text" name="q" placeholder="Bairro, cidade ou código (ex.: LI025)">
...
<section class="section">
  <div class="shell split">
    <div class="reveal">
      <img loading="lazy" src="https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?auto=format&fit=crop&w=900&q=70" alt="Atendimento Luis Imóveis">
    </div>
    <div class="reveal">
      <span class="eyebrow">Quem somos</span>
      <h2 style="font-size:clamp(28px,4vw,42px);margin:14px 0 16px">Uma imobiliária de bairro, com padrão de gente grande.</h2>
      <p class="lead" style="margin-bottom:22px">A Luis Imóveis nasceu para descomplicar a compra, a venda e a locação de imóveis — unindo conhecimento da região a um atendimento que trata cada negócio como único.</p>
      <ul class="caracs" style="margin-bottom:26px">
        ...
        <li>Atendimento humano por WhatsApp</li>
        <li>Regularizada — <?php echo e(SITE_CRECI); ?></li>
      </ul>
      <a class="btn btn-dark" href="sobre.php">Conheça a Luis Imóveis</a>
    </div>
  </div>
</section>
  ...
  <div class="shell">
    <div class="cta-band reveal">
      <div>
        ...
        <h2>Anuncie seu imóvel com a Luis Imóveis.</h2>
